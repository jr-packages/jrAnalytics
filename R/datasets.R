...
#' We are interested in whether there is any association between star sign and success.
#' @docType data
NULL
...
#' @description Advertising expenditure in three different media for some product with corresponding sales of this product.
