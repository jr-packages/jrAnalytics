#' mortgage data
#'
#' Example data for the analytics course
#'
#' @name mortgage
#' @docType data
#' @usage data(mortgage)
...
#' @keywords datasets
#' @examples
#' data(beams, package="jrAnalytics")
NULL
...
#'
#' @description The \code{ratfeed} data set. An example of the
#' factorial ANOVA design. The \code{ratfeed2} and \code{ratfeed3}
#' datasets are similar to the original data, but are used to
#' illustrate variable encoding.
#' @docType data
#' @usage data(ratfeed)
#' @return A data frame
#' @keywords datasets
...
#'
#' @description This data set contains the number of honey producing
#' bee colonies (Thousands of colonies (USDA)) in the US and the Divorce
#' rate in South Carolina (Divorces per 1000 people (US Census)). With a
#' correlation of 0.9, this is clearly a significant result.
#'
...
#'
#' @description Sizes of the England XV to the equivalent
#' week in the Five/Six Nations of in 1962, 1972, ..., 2012.
...
#' of chopsticks for children and adults. They came up with a measure of
#' how effective a pair of chopsticks performed, called the "Food Pinching
#' Performance". The "Food Pinching Performance" was determined by
#' counting the number of peanuts picked and placed in a cup (PPPC).
#'
...
#' @name zodiac
#' @title Zodiac signs of CEOs
#'
#' @description Numbers of successful business personal by zodiac sign.
#' We are interested in whether there is any association between star
#' sign and success.
#' @docType data
NULL
...
#' of 2014 on the Facebook's page of a renowned cosmetics brand. This
#' dataset contains 500 of the 790 rows and part of the features
#' analyzed by Moro et al. (2016). The remaining were omitted due to
#' confidentiality issues. Lifetime post total reach	The number of
#' people who saw a page post (unique users).
#' \describe{
...
#' clicked or not. People may see multiple impressions of the same
#' post. For example, someone might see a Page update in News Feed
#' once, and then a second time if a friend shares it.}
...
#' anywhere in a post.}
#' \item{Lifetime post consumptions}{The number of clicks anywhere
#' in a post.}
#' \item{Lifetime post impressions by people who have liked a page}{Total
#' number of impressions just from people who have liked a
#' page.}
#' \item{Lifetime post reach by people who like a page}{The number
#' of people who saw a page post because they have liked that page
#' (unique users).}
#' \item{Lifetime people who have liked a page and engaged with a
#' post}{The number of people who have liked a Page and clicked anywhere
...
#' @name lsd
#' @title LSD & Maths
#' @description Group of volunteers was given LSD, their mean
#' scores on math exam and tissue concentrations of LSD were
#' obtained at n=7 time points.
#'
...
#' @name advertising
#' @title Advertising data for examples
#' @description Advertising expenditure in three different media for
#' some product with corresponding sales of this product.
#' Fabricated data for the purpose of examples in the analytics course.
#' @docType data
NULL
